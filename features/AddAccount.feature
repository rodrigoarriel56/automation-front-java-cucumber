...
Funcionalidade: Adicionar Contas
  ...
  Contexto: Evidenciar Teste;
    ...
    E preencho os campos para logar
      | rodrigoarriel56@gmail.com | A1B2C3D4E5 |
    E clico no botão Entrar
    E que utilizo o word para evidências com as informações de execução
      | Homologação | Adicionar contas na aplicação do Sr barriga | Adicionar contas na aplicação do Sr barriga | Adicionar contas na aplicação do Sr barriga com sucesso | Adicionar contas na aplicação do Sr barriga com sucesso | Rodrigo Arriel | 01 | 01 |
