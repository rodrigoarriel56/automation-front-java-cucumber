...
Funcionalidade: Cadastrar Novo Usuário na apicação do Sr Barriga
  ...
  Contexto: Evidenciar Teste;
    Dado que utilizo o word para evidências com as informações de execução
      | Homologação | Cadastrar Novo Usuário | Cadastrar Novo Usuário | Cadastrar Novo Usuário com sucesso | Cadastrar Novo Usuário com sucesso | Rodrigo Arriel | 01 | 01 |
  ...
  Esquema do Cenario: CT - CADASTRO DE USUÁRIO - Cadastrar Novo Usuário com erro.
    ...
    Exemplos:
      | NOME        | EMAIL             							 | SENHA                            | MENSAGEM                         |
      | "Rodrigo"   | "rodrigoarriel56@gmail.com"			 | "A1B2C3D4E5"                     | "Endereço de email já utilizado" |
      | ""          | "rap@gmail.com"                  | "A1B2C3D4E5"                     | "Nome é um campo obrigatório"    |
